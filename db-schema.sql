...
CREATE TABLE public.projects (
    ...
    subscription_trial_end timestamp with time zone NOT NULL,
    subscription_current_period_end timestamp with time zone NOT NULL,
    subscription_current_period_start timestamp with time zone NOT NULL,
